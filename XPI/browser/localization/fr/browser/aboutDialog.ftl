...
update-updateButton =
    .label = Redémarrer pour mettre { -brand-shorter-name } à jour
    .accesskey = R

update-checkingForUpdates = Recherche de mises à jour en cours…
...
community-2 = { -brand-short-name } est basé sur Mozilla Firefox adapté pour Windows XP/Server 2003.
