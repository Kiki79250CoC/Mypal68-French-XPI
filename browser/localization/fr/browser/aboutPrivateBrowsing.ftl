...
about-private-browsing-learn-more = En savoir plus sur la <a data-l10n-name="learn-more">navigation privée</a>.
about-private-browsing-info-visited = Les pages visitées
privatebrowsingpage-open-private-window-label = Ouvrir une fenêtre de navigation privée
    .accesskey = u
about-private-browsing-info-notsaved = Lorsque vous naviguez dans une fenêtre privée, { -brand-short-name } <strong>ne conservera pas</strong> :
about-private-browsing-search-placeholder = Rechercher sur le Web
about-private-browsing-info-bookmarks = Les marque-pages
about-private-browsing-info-title = Cette fenêtre de navigation est privée
about-private-browsing-info-searches = Les recherches
about-private-browsing-info-downloads = Les téléchargements
private-browsing-title = Navigation privée
about-private-browsing-info-saved = { -brand-short-name } <strong>conservera</strong> :
about-private-browsing-info-myths = Principales idées reçues sur la navigation privée
about-private-browsing-info-clipboard = Le texte copié
about-private-browsing-info-temporary-files = Les fichiers temporaires
about-private-browsing-info-cookies = Les cookies
